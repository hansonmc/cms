...
<title>卖点图新增<%--author:gzz_gzz@163.com,DATE:2016-09-10 14:43:41--%></title>
</head>
<body>
	<form:form id="form1" method="post" commandName="point">
		...
		<table class="dataTab">
			...
			<tr>
				...
				<td class="left30"><font color="#CE0000">*</font></td>
...
<!-- 			</tr> -->
			...
			<tr>
				<td class="right30">卖点图</td>
				<td class="left30"><form:input path="ts"  readonly="readonly" onClick="getPointRef('ts','status','${webPath}');"
					class="inputref" /><form:input path="status" /><font color="#CE0000">*</font></td>
				<td class="left30_red" id="dept_id_td"> </td>
			</tr>
		</table>
...
<script type="text/javascript">
	...
	function getPointRef(yourname, yourid, path) {
		var text, url, winWidth, winHeight, widId;
		text = "部门";
		url = path + "/point/ref?rname=" + yourname + "&rvalue=" + yourid;
		winWidth = 500;
