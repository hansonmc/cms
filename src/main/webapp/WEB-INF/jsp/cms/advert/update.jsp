	...
	<form:form name="form1" id="form1" method="post"  modelAttribute="advert" enctype="multipart/form-data" >
		...
		<table class="dataTab">
			...
			<tr>
				...
				<td class="left30">${advert.type_name}</td>
				<td class="left30_red" ></td>
			</tr>
			<tr>
				<td class="right30">图片</td>
				<td class="left30"><img id="img" src="${advert.picture_url}" style="width: 200px;height: 120px;" /> </td>
				<td class="left30_red" ></td>
			</tr>
			<tr>
...
// 		if(!isNumber($("#order_num").val())){//数字验证
		...
		if (count > 0) {//存在验证未通的项
	 	...
	 	toAction('${webPath}/advert/update');//新增-保存数据
	}
</script>
</html>